...
void loop() {
  ...
  if (editModu && ayarModu) {
    switch (secim) {
      case 0: ayarSaat   = deger; break;
      case 1: ayarDakika = deger; break;
      case 2: ayarSaniye = deger; break;
      case 3: ayarGun    = deger; break;
      case 4: ayarAy     = deger; break;
      case 5: ayarYil    = deger; break;
    }
  }
  ...
  if (currentMillis - sonEkranGuncelleme >= EKRAN_GUNCELLEME_SURESI) {
    switch (ekranDurumu) {
      case 1: lcdAnaEkran();     break;
      case 2: lcdMenu();         break;
      case 3: lcdSaatAyar(); 
              if (!ayarModu) saatAyarDegerleriYukle(); 
              break;
      case 4: lcdKuluckaAyar();  break;
      case 5: lcdAyarMenu();     break;
      case 6: lcdAyarMenu2();    break;
      case 7: lcdBaslatDurdur(); break;
    }
  ...
  if (makineAktif && bildirim != 2 && currentMillis - bildirimSuresi >= 3000) {
    if (bitRead(flags, FLAG_KAPAK_DURUMU)) bildirim = 2;
    else if (!bitRead(flags, FLAG_KAPAK_DURUMU) && makineAktif) bildirim = 3;
  }
